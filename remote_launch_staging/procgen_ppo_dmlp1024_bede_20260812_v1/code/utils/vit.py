...
class ViT(nn.Module):
    def __init__(self, *, image_size, patch_size, dim, depth, num_heads, embed_dim, channels = 3, dim_head = 64, dropout = 0., emb_dropout = 0.):
        super().__init__()
        ...
        self.transformer = Transformer(dim, depth, num_heads, dim_head, embed_dim, dropout)
