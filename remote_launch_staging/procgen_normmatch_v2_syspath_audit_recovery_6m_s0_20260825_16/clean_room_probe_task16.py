#!/usr/bin/env python3
"""Bundle import/config audit with exhaustive module-origin provenance."""
import hashlib
import importlib
...
namespace = {}
exec(compile(open(os.environ["ORIGIN_SAFETY"]).read(), os.environ["ORIGIN_SAFETY"], "exec"), namespace)
...
origin_payload = {
    "result": "IMPORT_ORIGIN_AUDIT_PASS",
    "designated_prestart": PRESTART,
    "designated_interpreter_start": before,
    "designated_after_import": after,
    "sys_path": path_manifest,
    **origins,
}
write_json(ORIGIN_OUT, origin_payload)
payload = {
    ...
    "import_origin_manifest": str(ORIGIN_OUT),
}
