    ...
    for epoch in tepochs:
        ...
        if not warmup_active:
            ...
            eta_v_after, critic_reason = dualtrust_update_value(
                ...
                algo_config.dualtrust_lower, algo_config.dualtrust_critic_upper,
                algo_config.dualtrust_eta_min, algo_config.dualtrust_eta_max,
                algo_config.dualtrust_multiplier,
            )
            if d_v_value > algo_config.dualtrust_critic_upper:
                critic_reason = 'ABOVE_0P01_MULTIPLY_1P5'
            if (
                ...
                or (d_v_value > algo_config.dualtrust_critic_upper and eta_v_after < eta_v_before)
            ...
            scheduler_row = {
                ...
                'd_pi': d_pi_value,
                'd_v': d_v_value,
                'critic_trust_upper': float(algo_config.dualtrust_critic_upper),
