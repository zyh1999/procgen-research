#!/usr/bin/env python3
"""Task55 read-only exact-2M paired-arm monitor."""
import argparse
import csv
import hashlib
import json
...
p.add_argument("--method", required=True, choices=(
    "FULL_SHARED_JOINT2B_NOWARMUP_FIXEDLR_DUALTRUST_BETA1_V1",
    "FULL_SHARED_JOINT2B_NOWARMUP_FIXEDLR_DUALTRUST_BETA4_V1",
))
