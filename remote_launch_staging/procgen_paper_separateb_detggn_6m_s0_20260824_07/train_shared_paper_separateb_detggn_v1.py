...
def solve_separate_critic_b_fp64(rows, rhs, denominator, damping, chunk_cols, jacobi_eps):
...
def learn(world_size, algo, actor_critic, writer, venv, device,
    ...
    gamma = .999
    lam = .95
    validate_separateb_config(algo_config)
    ...
    def Advantage_Update(_obs, _act, _adv, _ret, _outputs_old):
        ...
        # Literal Paper actor objective; only the critic contribution is
