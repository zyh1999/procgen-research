...
launcher = campaign / "frozen/gae_ggn_head_widentity_6m_gpuh.sbatch"
...
spec = importlib.util.spec_from_file_location("gae_widentity_trainer", trainer)
...
module.validate_gae_widentity_config(
