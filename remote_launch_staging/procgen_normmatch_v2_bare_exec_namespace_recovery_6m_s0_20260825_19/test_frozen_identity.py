#!/usr/bin/env python3
"""Prove Task19 preserved every frozen scientific/deployment identity."""
import hashlib
...
TASK18 = ROOT / "procgen_normmatch_v2_torch_generated_origin_audit_6m_s0_20260825_18"
EXPECTED = {
    ...
    TASK18 / "origin_safety.py": "889b914a792132358f90572d5c4f16b561c60bf0615eb8492c9ecf781f601fc1",
    TASK18 / "provenance_probe.py": "917faf124f35ca7a1c4ceef4a8dc43183500cbc2131c71f95f8d2186c51f6c23",
}
for path, expected in EXPECTED.items():
    actual = hashlib.sha256(path.read_bytes()).hexdigest()
    assert actual == expected, (path, actual, expected)
print("TASK19_FROZEN_IDENTITY_TEST_PASS")
