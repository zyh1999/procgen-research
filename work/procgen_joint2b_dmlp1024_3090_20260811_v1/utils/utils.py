...
class SharedActorCritic(nn.Module):
    def __init__(self, fn_embed_net, obs_shape, nets_config, n_actions=None, 
        ...
        # Optional shared decision MLP. Keeping this inside backbone_net makes
        # policy scores and critic value Jacobians use the same enlarged
        # representation in the strict joint 2B system.
