...
TRAINER=train_shared_joint2b_mujocoported_rownorm_fisherhysteresis.py
CONFIG=adv_resnet_shared_joint2b_mujocoported_rownorm_fisherhysteresis_d003_d05_lr05_1m.yaml
EXPECTED_TRAINER_SHA=2fbce1cd0a1c14389eaafb39a14c7683abf921b3dc5c34d8edd8bfad81dd30c3
EXPECTED_CONFIG_SHA=3b2fd189e5db696693dae1c046fb2362d21e1ee7cc8a3ba196e614e898efbc4c
RUN="$ROOT/gate_1m_seed0_rownorm_fisherhysteresis_v1/rownorm_fisherhyst_e055_r065_d003_d05_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "DAMPING=FISHER_HYSTERESIS"
  echo "DAMPING_RULE=ENGAGE_F_LE_0.55_D_0.50__RELEASE_F_GE_0.65_D_0.03"
  echo "DAMPING_MIN=0.03"
  echo "DAMPING_MAX=0.50"
  echo "FISHER_HYSTERESIS=true"
  echo "FISHER_HYSTERESIS_ENGAGE=0.55"
  echo "FISHER_HYSTERESIS_RELEASE=0.65"
  ...
  echo "PARENT_GATE=rownorm_fisheradaptive_d003_d05_lr05"
  echo "CAUSAL_REASON=PREVENT_PER_MINIBATCH_DAMPING_RELEASE_DURING_LOW_FISHER_COLLAPSE"
} > "$RUN/preflight"
