...
TRAINER=train_shared_joint2b_mujocoported_rownorm_fisheradaptive.py
CONFIG=adv_resnet_shared_joint2b_mujocoported_rownorm_fisheradaptive_d003_d05_lr05_1m.yaml
EXPECTED_TRAINER_SHA=3ec04cfa75b0e1c5c19f819da4bc093ad23d29ec777f2882276cadcc52565831
EXPECTED_CONFIG_SHA=442438c52ae1571b730930dec7f53f2f35a815e21252e0328e7fb6ee66e3928b
RUN="$ROOT/gate_1m_seed0_rownorm_fisheradaptive_v1/rownorm_fisher_d003_d05_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "DAMPING=FISHER_ADAPTIVE"
  echo "DAMPING_RULE=F_GE_0.50_D_0.03__F_LE_0.35_D_0.50__LINEAR_BETWEEN"
  echo "DAMPING_MIN=0.03"
  echo "DAMPING_MAX=0.50"
  echo "FISHER_DAMPING_UPPER=0.50"
  echo "FISHER_DAMPING_LOWER=0.35"
  ...
  echo "PARENT_GATES=rownorm_d003_lr05,rownorm_d05_lr05"
  echo "CAUSAL_REASON=UNIFIED_FISHER_TRIGGER_PRESERVES_FAST_LEARNING_AND_PREVENTS_LOW_FISHER_COLLAPSE"
} > "$RUN/preflight"
