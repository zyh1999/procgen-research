...
CONFIG=adv_resnet_shared_joint2b_mujocoported_rownorm_schurautoguard_r2wide_d003_lr05_1m.yaml
EXPECTED_TRAINER_SHA=ffeef78ab9c6f1c6990631eddd643fe5d69eefedf299808eb28b8d3ee837d353
EXPECTED_CONFIG_SHA=9708cbb2659e6048035104ffcd8a1ecc6d7b04aa889136ff6f55400bd708d234
RUN="$ROOT/smoke_120k_seed0_rownorm_schurautoguard_r2wide_v1/schurautoguard_r2wide_d003_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "SCHUR_FLOOR_CANDIDATES=0.03,0.1,0.3,0.5,1.0,3.0,10.0,30.0,100.0,300.0,1000.0"
  ...
  echo "PARENT_FAILURE=gate_200k_seed0_rownorm_schurautoguard_r2_v1"
} > "$RUN/preflight"
