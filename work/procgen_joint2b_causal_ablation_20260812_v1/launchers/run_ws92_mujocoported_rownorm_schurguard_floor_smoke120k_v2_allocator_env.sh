...
case "$FLOOR_TAG" in
  c05)
    CONFIG=adv_resnet_shared_joint2b_mujocoported_rownorm_schurguard_c05_d003_lr05_1m.yaml
    EXPECTED_CONFIG_SHA=a76f7a9573a4cde1939f470a2514197bd529d7b6ff854c2d9060704f5d02031d
    CRITIC_FLOOR=0.5
    ;;
  c10)
    ...
    CRITIC_FLOOR=1.0
    ;;
  *) echo "FLOOR_TAG must be c05 or c10" >&2; exit 2;;
esac
...
RUN="$ROOT/smoke_120k_seed0_rownorm_schurguard_floor_v2/rownorm_schur_${FLOOR_TAG}_d003_lr05/$ENV_NAME/seed0"
