...
RUN="$ROOT/gate_1m_seed0_rownorm_schurguard_c1_v1/rownorm_schur_c1_d003_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "PARENT_GATE=rownorm_fisherhyst_e055_r065_d003_d05_lr05"
  echo "CAUSAL_REASON=BOUND_CRITIC_SCHUR_AMPLIFICATION_OF_ACTOR_RHS"
} > "$RUN/preflight"
