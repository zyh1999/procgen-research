...
RUN="$ROOT/smoke_20k_seed0_rownorm_schurautoguard_r2_v1/schurautoguard_r2_d003_lr05/$ENV_NAME/seed0"
...
cmd=("$PY" -u "$TRAINER" --config "$CONFIG"
  ...
  --total_timesteps 20000 --joint_ablation_mode full_joint
