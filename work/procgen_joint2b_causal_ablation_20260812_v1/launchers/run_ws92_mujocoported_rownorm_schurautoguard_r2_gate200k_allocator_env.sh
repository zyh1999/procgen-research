...
TRAINER=train_shared_joint2b_mujocoported_rownorm_schurautoguard.py
CONFIG=adv_resnet_shared_joint2b_mujocoported_rownorm_schurautoguard_r2_d003_lr05_1m.yaml
EXPECTED_TRAINER_SHA=ffeef78ab9c6f1c6990631eddd643fe5d69eefedf299808eb28b8d3ee837d353
EXPECTED_CONFIG_SHA=de36baed8d0fd594358b3a879e12c021499d4e36772d3ef311ca0dde427b544f
RUN="$ROOT/gate_200k_seed0_rownorm_schurautoguard_r2_v1/schurautoguard_r2_d003_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "SCHUR_AUTOGUARD=true"
  echo "SCHUR_RATIO_MAX=2.0"
  echo "SCHUR_FLOOR_CANDIDATES=0.03,0.1,0.3,0.5,1.0,3.0,10.0"
  ...
  echo "PARENT_SMOKE=smoke_20k_seed0_rownorm_schurautoguard_r2_v1"
} > "$RUN/preflight"

cmd=("$PY" -u "$TRAINER" --config "$CONFIG"
  --env_name "$ENV_NAME" --seed 0 --device 0
  --total_timesteps 200000 --joint_ablation_mode full_joint
