...
RUN="$ROOT/gate_1m_seed0_rownorm_d05_retry1_allocator_v1/rownorm_d05_lr05/$ENV_NAME/seed0"
...

{
  ...
  echo "RETRY_OF=gate_1m_seed0_rownorm_d05_v1"
  echo "RETRY_REASON=CUDA_ALLOCATOR_FRAGMENTATION"
} > "$RUN/preflight"
